            ...
            if (recipient.isPresent()) {
                if (sender_balance.compareTo(transactionAmount) >= 0) {
                    try {
                        ...
                        CustomerDTO senderSuccess = customerService.getByIdWithCustomerDTO(transferDTO.getSenderId());
                        CustomerDTO recipientSuccess = customerService.getByIdWithCustomerDTO(transferDTO.getRecipientId());
