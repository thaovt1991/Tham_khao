...
public class TransferServiceImpl implements ITransferService {
    ...
    @Override
    public List<ITransactionDTO> findAllITransactionDTO() {
        return transferRepository.findAllITransactionDTO();
    }

    @Override
    public List<TransactionDTO> findAllTransactionDTO() {
        return transferRepository.findAllTransactionDTO();
    }
